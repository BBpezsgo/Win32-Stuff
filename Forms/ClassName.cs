...
{
    public const string Header = "SysHeader32";
    ...
    /// </para>
    /// </summary>
    public const string RichEdit = "RICHEDIT_CLASS";
    ...
    public const string ProgressBar = "msctls_progress32";

    public const string IPAddress = "SysIPAddress32";
}
