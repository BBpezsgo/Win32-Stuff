...
public static class MenuStyles
{
    ...
    /// Menu owner receives <see cref="WindowMessage.WM_MENUDRAG"/> and
    /// <see cref="WindowMessage.WM_MENUGETOBJECT"/> messages.
    /// </summary>
    ...
    /// <summary>
    /// Menu owner receives a <see cref="WindowMessage.WM_MENUCOMMAND"/> message instead
    /// of a <see cref="WindowMessage.WM_COMMAND"/> message when the user makes a selection.
