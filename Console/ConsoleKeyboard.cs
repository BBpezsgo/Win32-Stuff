...
public static class ConsoleKeyboard
{
    ...
    public static bool IsKeyPressed(char key) => IsKeyPressed(Win32.Keyboard.ToVK(key).Key);
    ...
    /// <exception cref="ArgumentOutOfRangeException"/>
    public static bool IsKeyHold(char key) => IsKeyHold(Win32.Keyboard.ToVK(key).Key);

    /// <exception cref="ArgumentOutOfRangeException"/>
    public static bool IsKeyHold(VirtualKeyCode key) => BitUtils.GetBit(Holding, (int)key);

    /// <exception cref="ArgumentOutOfRangeException"/>
    public static bool IsKeyDown(char key) => IsKeyDown(Win32.Keyboard.ToVK(key).Key);
    ...
    /// <exception cref="ArgumentOutOfRangeException"/>
    public static bool IsKeyUp(char key) => IsKeyUp(Win32.Keyboard.ToVK(key).Key);
    ...
    /// <exception cref="ArgumentOutOfRangeException"/>
    public static bool IsActive(char key) => IsActive(Win32.Keyboard.ToVK(key).Key);
