...
namespace Win32
{
    ...
    unsafe public struct MenuItemInfo
    {
        ...
        /// Set fMask to <see cref="MenuItemInfoMasks.TYPE"/> to use <c>fType</c>.
        /// </para>
        /// <para>
        /// <c>fType</c> is used only if <see cref="fMask"/> has a value of <see cref="MenuItemInfoMasks.FTYPE"/>.
        /// </para>
        /// </summary>
        public UINT fType;
        /// <summary>
        /// The menu item state.
        /// See <see cref="MFS"/>
        /// Set <see cref="fMask"/> to <see cref="MenuItemInfoMasks.STATE"/> to use <see cref="fState"/>.
        /// </summary>
        public UINT fState;
        /// <summary>
        /// An application-defined value that identifies the menu item.
        /// Set <see cref="fMask"/> to <see cref="MenuItemInfoMasks.ID"/> to use <see cref="wID"/>.
        /// </summary>
        public UINT wID;
        /// <summary>
        ...
        /// this member is <c>NULL</c>. Set <see cref="fMask"/> to <see cref="MenuItemInfoMasks.SUBMENU"/> to use <c>hSubMenu</c>.
        /// </summary>
        ...
        /// to <see cref="MenuItemInfoMasks.CHECKMARKS"/> to use <c>hbmpChecked</c>.
        /// </summary>
        ...
        /// Set <see cref="fMask"/> to <see cref="MenuItemInfoMasks.CHECKMARKS"/> to use <c>hbmpUnchecked</c>.
        /// </summary>
        public HBITMAP hbmpUnchecked;
        /// <summary>
        /// An application-defined value associated with the menu item.
        /// Set <see cref="fMask"/> to <see cref="MenuItemInfoMasks.DATA"/> to use <c>dwItemData</c>.
        /// </summary>
        public ULONG_PTR dwItemData;
        /// <summary>
        /// <para>
        /// The contents of the menu item. The meaning of this member depends on the value
        /// of <c>fType</c> and is used only if the <see cref="MenuItemInfoMasks.TYPE"/> flag
        ...
        /// </para>
        /// <para>
        /// <c>dwTypeData</c> is used only if the <see cref="MenuItemInfoMasks.STRING"/> flag is set in the <c>fMask</c> member
        /// </para>
        /// </summary>
        ...
        /// the <see cref="MenuItemInfoMasks.TYPE"/> flag is set in the <c>fMask</c> member and is
        ...
        /// </para>
        /// <para>
        /// The <c>cch</c> member is used when the <see cref="MenuItemInfoMasks.STRING"/> flag is set in the <c>fMask</c> member.
        /// </para>
        /// </summary>
        public UINT cch;
        /// <summary>
        ...
        /// It is used when the <see cref="MenuItemInfoMasks.BITMAP"/> flag is set in the <c>fMask</c> member.
        /// </summary>
