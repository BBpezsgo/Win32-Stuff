...
namespace Win32
{
        ...
        System.Numerics.IEqualityOperators<ProcessSnapshot, ProcessSnapshot, bool>
    {
        ...
        public bool Equals(ProcessSnapshot other) => Handle.Equals(other.Handle);
    ...
    public class ProcessSnapshotEnumerator : IEnumerator<ProcessEntry>
    {
        ...
        unsafe public void Reset()
        {
            ...
            {
                StructSize = (uint)sizeof(ProcessEntry),
            };
        ...
        ~ProcessSnapshotEnumerator() { Dispose(disposing: false); }
        public void Dispose()
        {
