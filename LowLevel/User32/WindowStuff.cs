...
public static partial class User32
{
    ...
    public static extern unsafe BOOL UpdateLayeredWindow(
      ...
      [In] COLORREF crKey,
      [In, Optional] Forms.BlendFunction* pblend,
      [In] DWORD dwFlags
    );
    ...
    public static extern HWND ChildWindowFromPointEx(
      [In] HWND hwnd,
      [In] POINT pt,
      [In] Forms.ChildWindowFromPointFlags flags
    );
    ...
    public static extern BOOL SetWindowPos(
      ...
      [In] int cx,
      [In] int cy,
      [In] Forms.SetWindowPosFlags uFlags
    );
    ...
    /// It can be either <see cref="AnimateWindowFlags.HPositive"/>, <see cref="AnimateWindowFlags.HNegative"/>,
    /// <see cref="AnimateWindowFlags.VPositive"/>, or <see cref="AnimateWindowFlags.VNegative"/>.
    /// </para>
    /// <para>
    /// You can combine <see cref="AnimateWindowFlags.HPositive"/> or <see cref="AnimateWindowFlags.HNegative"/> with
    /// <see cref="AnimateWindowFlags.VPositive"/> or <see cref="AnimateWindowFlags.VNegative"/> to animate a window diagonally.
    /// </para>
    /// <para>
    ...
    public static extern BOOL AnimateWindow(
      [In] HWND hWnd,
      [In] DWORD dwTime,
      [In] Forms.AnimateWindowFlags dwFlags
    );
    ...
    public static extern HWND GetAncestor(
      [In] HWND hwnd,
      [In] Forms.GetAncestorFlags gaFlags
    );
