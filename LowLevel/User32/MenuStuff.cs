...
namespace Win32.LowLevel
{
    public static partial class User32
    {
        ...
        /// </para>
        /// <para>
        /// For more information about menu item type and state flags, see the <see cref="MENUITEMINFOW"/> structure.
        /// </para>
        /// </remarks>
        [DllImport("User32.dll", SetLastError = true)]
        ...
        /// of <see cref="MENUITEMINFOW"/> to <c>NULL</c> and then calling <c>GetMenuItemInfo</c>.
        ...
        /// </param>
        /// <param name="lpmii">
        /// A pointer to a <see cref="MENUITEMINFOW"/> structure that contains information
        ...
        /// </param>
        /// <param name="lpmi">
        /// A pointer to a <see cref="MENUITEMINFOW"/> structure that contains information about the new menu item.
        /// </param>
        /// <returns>
        /// <para>
        /// If the function succeeds, the return value is nonzero.
