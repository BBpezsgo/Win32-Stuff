...
public interface IDWriteFontFace
{
    ...
    /// </summary>
    extern FontSimulations GetSimulations();
    ...
    extern unsafe void GetMetrics(
        [Out] FontMetrics* fontFaceMetrics
    );
    ...
    extern unsafe void GetRecommendedRenderingMode(
        ...
        [Out] RenderingMode* renderingMode
    );
