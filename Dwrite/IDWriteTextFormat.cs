...
public interface IDWriteTextFormat
{
    ...
    /// </summary>
    abstract TextAlignment GetTextAlignment();

    /// <summary>
    /// Get alignment option of paragraph relative to layout box's top and bottom edge.
    /// </summary>
    abstract ParagraphAlignment GetParagraphAlignment();

    /// <summary>
    /// Get word wrapping option.
    /// </summary>
    abstract WordWrapping GetWordWrapping();

    /// <summary>
    /// Get paragraph reading direction.
    /// </summary>
    abstract ReadingDirection GetReadingDirection();

    /// <summary>
    /// Get paragraph flow direction.
    /// </summary>
    abstract FlowDirection GetFlowDirection();
    ...
    /// Get the font weight.
    /// </summary>
    abstract FontWeight GetFontWeight();

    /// <summary>
    /// Get the font style.
    /// </summary>
    abstract FontStyle GetFontStyle();

    /// <summary>
    /// Get the font stretch.
    /// </summary>
    abstract FontStretch GetFontStretch();
